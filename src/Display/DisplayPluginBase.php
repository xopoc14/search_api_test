...
abstract class DisplayPluginBase extends HideablePluginBase implements DisplayInterface {
  ...
  public function getUrl() {
    @trigger_error('\Drupal\search_api\Display\DisplayInterface::getUrl() is deprecated in Search API 8.x-1.0 Beta 5. Use ::getPath() instead. See https://www.drupal.org/project/search_api/issues/2856050', E_USER_DEPRECATED);
